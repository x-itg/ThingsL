...
-------------
1. [MCU]:STM32F401CCU6
2. [STM32CubeIDE Version: 1.9.0：./tingsdemo/.project](./tingsdemo/.project)    
3. [iar 9.10.2 工程文件：./tingsdemo/EWARM/Project.eww](./tingsdemo/EWARM/Project.eww) 
4. [电路原理图：./Pen电路.pdf](./Pen电路.pdf) 
5. [主要代码：./tingsdemo/Core/Src/TINGSOS.c](./tingsdemo/Core/Src/TINGSOS.c)
